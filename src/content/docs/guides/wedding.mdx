...
After the flight to Mumbai, you can take a cab to Nashik. The distance between Mumbai and Nashik is around 170 km and it takes around 3-4 hours to reach Nashik from Mumbai. You can use Uber or Ola outstaion services for the same. If you are travelling in a group, you can also book a cab from Mumbai to Nashik.
